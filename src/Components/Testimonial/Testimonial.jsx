      ...
      <section className="my-8">
        ...
        <div className="container flex flex-col items-center justify-center mx-auto lg:flex-row lg:flex-wrap lg:justify-evenly lg:px-10">
          <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg">
            <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 dark:bg-gray-900">
              <p className="relative px-6 py-1 text-lg italic text-center dark:text-gray-100">
                ...
                <svg
                  ...
                  viewBox="0 0 512 512"
                  fill="currentColor"
                  className="absolute right-0 w-8 h-8 text-red-100"
                >
            ...
            <div className="flex flex-col items-center justify-center p-8 rounded-b-lg bg-red-100 dark:text-gray-900">
              <img
          ...
          <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg">
            ...
            <div className="flex flex-col items-center justify-center p-8 rounded-b-lg bg-red-100 dark:text-gray-900">
              <img
                ...
                className="w-16 h-16 mb-2 -mt-16 bg-center bg-cover rounded-full dark:bg-gray-500 dark:bg-gray-700"
              />
              <p className="text-xl font-semibold leadi">Clerk Kent</p>
